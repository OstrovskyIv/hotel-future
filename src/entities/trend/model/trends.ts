...
export const trends: Trend[] = [
  {
    ...
    impact: "Luxury: Отель знает ваши желания.",
    icon: "Sparkles",
    mainImage: "tech-4.webp"
  },
  {
  ...
  },
  {
    ...
    impact: "Безопасность: Ваши данные — единственный ключ к пространству.",
    icon: "ShieldCheck",
    mainImage: "tech-4.webp"
  },
  {
